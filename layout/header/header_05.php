                            ...
                            <div class="row">
                                <div class="hidden-xs col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    <div class="welcome-user hidden-xs">
                                        <?php esc_html_e('Hello guys ! Welcome to Logancee Store !', 'logancee'); ?>
                                    </div>
                                </div>
                                    ...
                                    <?php else: ?>
                                        <?php if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) : ?>
                                            <div class="hidden-xs login-topbar">
                                                <a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" class="nav-top-link"><span><i aria-hidden="true" class="icon_lock">&nbsp;</i><?php esc_html_e('Login', 'logancee'); ?></span></a>
                                            </div>
                                            <div class="hidden-xs register-topbar">
                                        ...
                                        <?php else: ?>
                                            <div class="hidden-xs login-topbar">
                                                <a href="<?php echo wp_login_url( esc_url( home_url( '/' ) ) ); ?>" class="nav-top-link"><span><i aria-hidden="true" class="icon_lock">&nbsp;</i><?php esc_html_e('Login', 'logancee'); ?></span></a>
                                            </div>
                                            <div class="hidden-xs register-topbar">
