                        ...
                        <div class="sticky-header is-sticky">
                            ...
                            <div class="sticky-icon-group">
                                <div class="sticky-search">
                                    ...
                                    <div class="quick-search">
                                        <form class="form-search" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                                            <input id="search2" type="text" name="search" value="" class="input-text" maxlength="128" placeholder="<?php echo __('Search', 'logancee'); ?>" autocomplete="off">
                                            <input type="hidden" name="post_type" value="product" />
                                            <button type="submit" title="Search" class="button-search"><span><i aria-hidden="true" class="icon_search"></i></span></button>
                                        </form>
                                        <i aria-hidden="true" class="icon_close"></i>
                            ...
                            <div id="megamenu" class="main-menu">
