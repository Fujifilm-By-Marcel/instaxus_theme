<?php
add_action('widgets_init', 'logancee_custom_block_load_widgets');

function logancee_custom_block_load_widgets() {
    register_widget('Logancee_Custom_Block_Widget');
}

class Logancee_Custom_Block_Widget extends WP_Widget {

    public function __construct() {
        $widget_ops = array( 'description' => esc_html__('Add a custom block menu to your site.', 'logancee') );
        parent::__construct( 'custom_block', esc_html__('Custom Block', 'logancee'), $widget_ops );
    }
    ...
    public function form( $instance ) {
        ...
        if(! $my_query->have_posts() ) {
            ...
            echo '<p>'. sprintf( esc_html__('No custom blocks have been created yet.', 'logancee') ) .'</p>';
            return;
        }
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('custom_block')); ?>"><?php esc_html_e('Select Custom Block:', 'logancee'); ?></label>
