...
<?php
    ...
    <div class="box clearfix">
      ...
      <div class="box-heading"><?php esc_html_e( 'You may be interested in&hellip;', 'woocommerce' ) ?></div>
      <div class="strip-line"></div>
      <div class="box-content products related-products">
        <div class="box-product">
          <div id="myCarousel<?php echo esc_attr($id); ?>" <?php if($logancee_options['productpage-related-status']) { ?>class="carousel slide"<?php } ?>>
              <!-- Carousel items -->
