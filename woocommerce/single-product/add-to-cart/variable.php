...
do_action( 'woocommerce_before_add_to_cart_form' ); ?>
	...
	<?php else : ?>
		<div class="variations" cellspacing="0">
            <div class="options">
                <h2><?php esc_html_e('Available Options', 'logancee') ?></h2>
            <?php foreach ( $attributes as $attribute_name => $options ) : ?>
                <div class="form-group">
                    <label class="control-label" for="<?php echo sanitize_title( $attribute_name ); ?>"><?php echo wc_attribute_label( $attribute_name ); ?></label>
                    <div class="value">
                        <?php
