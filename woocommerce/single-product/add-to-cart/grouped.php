...
<form class="cart" method="post" enctype='multipart/form-data'>
	<table cellspacing="0" class="group_table">
		<thead>
		<tr>
			<th class="group-product-name"><?php _e( 'Product', 'woocommerce' ); ?></th>
			<th class="group-product-price"><?php _e( 'Price', 'woocommerce' ); ?></th>
			<th class="group-product-quantity"><?php _e( 'Quantity', 'woocommerce' ); ?></th>
		</tr>
		</thead>
		<tbody>
		<?php
