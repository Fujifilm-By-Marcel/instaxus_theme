...
function outputGive10Form() {
	...
	<div id="postbox">
		...
		<div class="input-container">
			...
			<input type="file" id="images[]" name="images[]" multiple required style="background: transparent !important;"></input><br>
		</div>
		
		<div class="input-container">
			<label for="info"><?php echo $field_labels['info'] ?></label><br />
			<textarea rows="4" cols="50" id="info" name="info" required><?php echo $_POST['info'] ?></textarea><br><br>
		</div>
		
		<div class="terms" style="overflow: scroll;height: <?php the_sub_field("terms_height") ?>;overflow-x: hidden;margin:40px 0;">
		...
		<div class="input-container"> 	
			<input type="submit" value="<?php echo $field_labels['submit'] ?>" id="submit" name="submit" accept="image/*" />
		</div>
