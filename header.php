...
<div class="<?php if($logancee_options['layout-main'] == 2) { echo 'fixed-body'; } else { echo 'standard-body'; } ?>">
	<div id="main" class="<?php if($logancee_options['layout-main'] == 2) { echo 'main-fixed'; } ?>">
        ...
        <div class="breadcrumb <?php if($logancee_options['layout-breadcrumb'] == 1) { echo 'full-width'; } else { echo 'fixed'; } ?>">
            ...
            <?php $blogbackground = "/wp-content/themes/Instax/images/instazine-feature2.jpg"; ?>
        <?php
        // HOME (use set blog background image)	

	
		
        if ( is_home() ) { ?>
            <?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'single-post-thumbnail' ); ?>
            <div class="background featured-image" style="background-image: url(<?php echo $blogbackground; ?> ); background-size: cover; background-repeat:no-repeat;background-position:center;">
        ...
        //  PRESS HUB DATE ARCHIVES
        elseif ( is_date() and in_category('297') ) { ?>
            <div class="background featured-image press-hub-feature">
                <div class="shadow"></div>
                <div class="pattern">
                    <div class="container">
                        <div class="clearfix">
                            ...
                            <?php if (get_post_meta(get_the_ID(), 'title', true) != 'title') : ?>
                                <h1 id="press-hub-title">
                                    ...
                                    <?php }
                                            ...
                                            <p class="marginb0"><?php logancee_get_page_title(); ?></p>
                                        <?php }
                                    ?>
                            <?php endif; ?>
                            </div>
        ...
        <? }
        // INSTAZINE BANNERS AND SINGLE POSTS (use featured image)
        elseif ( is_category('297') or is_tag('-360','-361', '-362') or is_search() or is_single() ) { ?>
         <?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'single-post-thumbnail' ); ?>
            <div class="background featured-image" style="background-image: url(<?php echo $image[0]; ?>)!important; background-size: cover; background-repeat:no-repeat;background-position:center;">
                <div class="shadow"></div>
                <div class="pattern">
                    <div class="container">
                        <div class="clearfix">
                            ...
                            <?php } ?>
                            <?php endif; ?>
                            <p class="text-center"><?php echo category_description( $category_id ); ?></p>
                            <?php if(logancee_show_breadcrumbs()):?>
                            <?php  logancee_breadcrumbs(); ?>
                            <?php endif; ?>
                            </div>
                        </div>
                    </div>
        ...
        // PRESS HUB BANNER
         elseif (
            in_category('Press Articles')
            or is_date()
            or is_tag($tag = array('360','361','362')) 
            or is_tag($tag = array('Printers articles', 'Film articles', 'Cameras articles')) 
            or is_category('297') ) { ?>
            <div class="background featured-image press-hub-feature">
                <div class="shadow"></div>
                <div class="pattern">
        ...
        <? }
        elseif ( get_field('show_banner_box') ) { ?>
                <?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'single-post-thumbnail' ); ?>
                <div class="background featured-image" style="background-image: url(<?php echo $image[0]; ?>); background-size: cover; background-repeat:no-repeat;background-position:center;">
                <div class="shadow"></div>
                <div class="pattern">
                    <div class="container">
                        <div class="clearfix">
